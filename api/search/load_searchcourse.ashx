<%@ WebHandler Language="C#" Class="load_searchcourse" %>
...
public class load_searchcourse : IHttpHandler
{
    ...
    {
        //执行查询操作，并获得返回的行数
        DataSet ds = DBHelper.sqlMethod("select course_img_url,course_name,teacher_name,course_score,course_time,course_introduction,course_id,teacher_id from t_course, t_teacher  where t_teacher.teacher_id =t_course.course_id and course_name like '%" + keyword + "%' order by course_id desc");
