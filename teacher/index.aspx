<%@ Page Language="C#" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="tea_index" %>

<%@ Register Src="~/header.ascx" TagPrefix="uc1" TagName="header" %>
<%@ Register Src="~/footer.ascx" TagPrefix="uc1" TagName="footer" %>
<%@ Register Src="./authCheck.ascx" TagPrefix="uc1" TagName="authCheck" %>
<!DOCTYPE html>
 <uc1:authCheck runat="server" ID="authCheck" />
